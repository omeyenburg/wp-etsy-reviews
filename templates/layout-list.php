...
function render_stars_list($rating, $size = 'large') {
...
?>
<div class="etsy-reviews-list">
    <div class="etsy-list-header">
        <div class="etsy-list-header-content">
            <?php echo render_stars_list(round($avg_rating * 2) / 2, 'large'); ?>
            <div class="etsy-list-rating-text">
                <?php echo number_format($avg_rating, 1, ',', '.'); ?> von 5 Sternen
            </div>
            <div class="etsy-list-logo">
            ...
            <div class="etsy-list-review-count">
                <span>Basierend auf <strong><?php echo esc_html($total_reviews); ?> Bewertungen</strong></span>
            </div>
        </div>
    </div>
    <div class="etsy-list-container">
        <?php foreach($reviews as $review): ?>
            <div class="etsy-list-item">
                <div class="etsy-list-item-header">
                    <div class="etsy-list-platform-badge" title="Gepostet auf Etsy">
                    ...
                    <div class="etsy-list-avatar">
                        <img src="https://www.etsy.com/images/avatars/default_avatar_75x75.png" alt="Verified buyer" loading="lazy">
                    </div>
                    <div class="etsy-list-reviewer-info">
                        <div class="etsy-list-name">Verifizierter Käufer</div>
                        <div class="etsy-list-date">
                            <?php
                ...
                <?php echo render_stars_list($review['rating'], 'small'); ?>
                <div class="etsy-list-text">
                    <?php echo esc_html($review['comment']); ?>
                </div>
                <?php if (!empty($review['display_image']) && !empty($review['product_url'])): ?>
                    <div class="etsy-list-image">
